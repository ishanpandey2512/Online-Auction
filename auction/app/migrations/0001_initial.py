# Generated by Django 2.1.1 on 2018-09-29 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateTimeField(default=datetime.datetime(2018, 9, 30, 8, 34, 26, 199753, tzinfo=utc))),
                ('current_bid', models.IntegerField(default=0)),
                ('product_sold', models.BooleanField(default=False)),
                ('seller_id', models.CharField(max_length=50, null=True)),
                ('bidder_id', models.CharField(max_length=50, null=True)),
