...
class Product(models.Model):
    ...
    end = models.DateTimeField(default=timezone.now() + timezone.timedelta(minutes=3))
    ...
    rent_time_end = models.DateTimeField(default=timezone.now() + timezone.timedelta(minutes=3))
